...
// import { increment } from "../Redux/ConterSlice";
...
//     (myuserData)=> myuserData.countStore.count
//   )

  
//   console.log(Myuser,"Redux")
...
//               Taste that stays in your heart ❤️ {Myuser}
//             </p>
//           </div>
//         </div>
...
//                     <Link
//                       to={`/view/${item._id}`}
//                       className="block px-4 py-2.5 text-gray-700 hover:text-red-500 hover:bg-amber-50 rounded-lg transition-colors"
...
function Header({ menu_data = [] }) {
  ...
  // Get user from Redux – assume it contains { id, name, email }
  // const user = useSelector((state) => state.userStore.user.payload);
          ...
          {isAuthenticated ? (
            <div className="flex flex-col items-center gap-3 ml-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
              >
                <LogOut size={18} />
                <span>Logout</span>
              </button>
              ...
              {isAuthenticated ? (
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full text-center px-5 py-3 bg-red-500 text-white font-semibold rounded-full shadow-md hover:bg-red-400 transition-all"
                  >
                    <LogOut size={18} />
                    Logout
                  </button>
